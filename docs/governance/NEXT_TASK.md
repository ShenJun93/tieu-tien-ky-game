...
```json
{
  ...
  "task_file": "docs/tasks/TASK-TIEU-TIEN-KY-PRODUCT-PROOF-SLICE-010-COMBAT-PHYSICS-PRODUCTIZATION-001.md",
  "evidence_file": "docs/evidence/PRODUCT_PROOF_SLICE_010_COMBAT_PHYSICS_PRODUCTIZATION_REPORT.md",
  "allowed_paths": [
    "docs/superpowers/specs/2026-08-30-ttk-product-proof-slice-010-combat-physics-productization-design.md",
    "docs/superpowers/plans/2026-08-30-ttk-product-proof-slice-010-combat-physics-productization-implementation.md",
    "docs/evidence/PRODUCT_PROOF_SLICE_010_COMBAT_PHYSICS_PRODUCTIZATION_REPORT.md",
    "docs/references/2026-08-30-slice-010-gpl-01-chr-01-visual-target.md",
    ...
    "Assets/_Project/Gameplay/ElementalReaction.cs",
    ...
    "Assets/_Project/Gameplay/MiniBossController.cs",
    "Assets/_Project/Gameplay/ArenaRunDirector.cs",
    "Assets/_Project/Gameplay/ArenaEventDirector.cs",
    ...
    "Assets/_Project/Characters/",
    "Assets/_Project/Animation/",
    "Assets/_Project/VFX/",
    "Assets/_Project/Audio/",
    "Assets/_Project/Tests/PlayMode/Slice010SpatialLoopTests.cs",
    "Assets/_Project/Tests/PlayMode/Slice010SpatialLoopTests.cs.meta",
    "Assets/_Project/Tests/PlayMode/Slice010TimingLoopTests.cs",
    "Assets/_Project/Tests/PlayMode/Slice010TimingLoopTests.cs.meta",
    "Assets/_Project/Tests/PlayMode/Slice010GaleCounterBuildMutationTests.cs",
    "Assets/_Project/Tests/PlayMode/Slice010GaleCounterBuildMutationTests.cs.meta",
    "Assets/_Project/Tests/PlayMode/Slice010CombatFeedbackTests.cs",
    "Assets/_Project/Tests/PlayMode/Slice010CombatFeedbackTests.cs.meta"
  ],
  "forbidden_paths": [
    "Packages/",
    "ProjectSettings/",
    ...
    "docs/tasks/TASK-TIEU-TIEN-KY-PRODUCT-PROOF-SLICE-010-COMBAT-PHYSICS-PRODUCTIZATION-001.md",
  ...
  "required_evidence": {
    ...
    "playmode_tests": "PASS",
    "android_build": "PASS",
    "spatial_loop_wired": "PASS",
    "timing_loop_wired": "PASS",
    "gale_counter_build_mutation": "PASS",
    "storm_control_remains_dormant": "PASS",
    "no_new_enemy_archetype": "PASS",
    ...
    "audio_capture_method_declared": "PASS",
  ...
  "product_gate": {
    "required": true,
    "player_promise": "A single 60-90 second solo-PvE run lets the player deliberately reposition and group enemies with Phong, exploit Water with Lightning for a bigger payoff, convert a well-timed Ho The block into an offensive opening against a telegraphed enemy, and feel the consequence of one build choice, at a production-quality bar for animation, VFX, audio and HUD that reads and sounds like a real mobile action game, not a Unity prototype.",
    "human_question": "On the physical Android target, during one 60-90 second representative encounter, does the Human feel they deliberately caused specific combat outcomes through Phong positioning/grouping, Water-Lightning exploitation, and a well-timed Ho The counter, rather than pressing four independent cooldown buttons, and does the experience read, sound and feel like production-quality mobile combat rather than a prototype?",
